        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Welcome {{ Str::ucfirst(Auth::user()->firstname) }} {{ Str::ucfirst(Auth::user()->lastname) }}</h3>
                    ...
                    <div class="justify-content-end d-flex">
                        <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                            <button aria-expanded="true" aria-haspopup="true"
                                class="btn btn-sm btn-light bg-white dropdown-toggle" data-toggle="dropdown"
                                id="dropdownMenuDate2" type="button">
                                <i class="mdi mdi-calendar"></i> Today (10 Jan 2021)
                            </button>
                            <div aria-labelledby="dropdownMenuDate2" class="dropdown-menu dropdown-menu-right">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card position-relative">
                <div class="card-body">
                    <div class="carousel slide detailed-report-carousel position-static pt-2" data-ride="carousel"
                        id="detailedReports">
                                                    ...
                                                    <table class="table table-borderless report-table">
                                                            ...
                                                            <td class="w-100 px-0">
                                                                <div class="progress progress-md mx-4">
                                                                    <div aria-valuemax="100" aria-valuemin="0"
                                                                        aria-valuenow="70" class="progress-bar bg-primary"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="w-100 px-0">
                                                                <div class="progress progress-md mx-4">
                                                                    <div aria-valuemax="100" aria-valuemin="0"
                                                                        aria-valuenow="30" class="progress-bar bg-warning"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="w-100 px-0">
                                                                <div class="progress progress-md mx-4">
                                                                    <div aria-valuemax="100" aria-valuemin="0"
                                                                        aria-valuenow="95" class="progress-bar bg-danger"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="w-100 px-0">
                                                                <div class="progress progress-md mx-4">
                                                                    <div aria-valuemax="100" aria-valuemin="0"
                                                                        aria-valuenow="60" class="progress-bar bg-info"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="w-100 px-0">
                                                                <div class="progress progress-md mx-4">
                                                                    <div aria-valuemax="100" aria-valuemin="0"
                                                                        aria-valuenow="40" class="progress-bar bg-primary"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="w-100 px-0">
                                                                <div class="progress progress-md mx-4">
                                                                    <div aria-valuemax="100" aria-valuemin="0"
                                                                        aria-valuenow="75" class="progress-bar bg-danger"
                        ...
                        <a class="carousel-control-prev" data-slide="prev" href="#detailedReports" role="button">
                            <span aria-hidden="true" class="carousel-control-prev-icon"></span>
                            <span class="sr-only">Previous</span>
                        </a>
                        <a class="carousel-control-next" data-slide="next" href="#detailedReports" role="button">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="add-items d-flex mb-0 mt-2">
                        <input class="form-control todo-list-input" placeholder="Add new task" type="text">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="progress progress-md flex-grow-1 mr-4">
                                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="95"
                                                class="progress-bar bg-inf0" role="progressbar" style="width: 95%"></div>
                                        </div>
                                        <p class="mb-0">5k</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="progress progress-md flex-grow-1 mr-4">
                                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="35"
                                                class="progress-bar bg-info" role="progressbar" style="width: 35%"></div>
                                        </div>
                                        <p class="mb-0">1k</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="progress progress-md flex-grow-1 mr-4">
                                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="48"
                                                class="progress-bar bg-info" role="progressbar" style="width: 48%"></div>
                                        </div>
                                        <p class="mb-0">992</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="progress progress-md flex-grow-1 mr-4">
                                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="25"
                                                class="progress-bar bg-info" role="progressbar" style="width: 25%"></div>
                                        </div>
                                        <p class="mb-0">687</p>
                                    </div>
                                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="icon-data-list">
                        <li>
                            <div class="d-flex">
                                <img alt="user" src="images/faces/face1.jpg">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img alt="user" src="images/faces/face2.jpg">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img alt="user" src="images/faces/face3.jpg">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img alt="user" src="images/faces/face4.jpg">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img alt="user" src="images/faces/face5.jpg">
                                <div>
