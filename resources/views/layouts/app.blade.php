        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a aria-controls="charts" aria-expanded="false" class="nav-link" data-toggle="collapse"
                            href="#charts">
                    ...
                    <li class="nav-item">
                        <a aria-controls="icons" aria-expanded="false" class="nav-link" data-toggle="collapse"
                            href="#icons">
                    ...
                    <li class="nav-item">
                        <a aria-controls="auth" aria-expanded="false" class="nav-link" data-toggle="collapse"
                            href="#auth">
                    ...
                    <li class="nav-item">
                        <a aria-controls="error" aria-expanded="false" class="nav-link" data-toggle="collapse"
                            href="#error">
                                    ...
                                    <div class="justify-content-end d-flex">
                                        <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                                            <button aria-expanded="true" aria-haspopup="true"
                                                ...
                                                data-toggle="dropdown" id="dropdownMenuDate2" type="button">
                                                <i class="mdi mdi-calendar"></i> Today (10 Jan 2021)
                                            </button>
                                            <div aria-labelledby="dropdownMenuDate2"
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card position-relative">
                                <div class="card-body">
                                    <div class="carousel slide detailed-report-carousel position-static pt-2"
                                        data-ride="carousel" id="detailedReports">
                                        ...
                                        <a class="carousel-control-prev" data-slide="prev" href="#detailedReports"
                                            role="button">
                                            <span aria-hidden="true" class="carousel-control-prev-icon"></span>
                                            <span class="sr-only">Previous</span>
                                        </a>
                                        <a class="carousel-control-next" data-slide="next" href="#detailedReports"
                                            role="button">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="add-items d-flex mb-0 mt-2">
                                        <input class="form-control todo-list-input" placeholder="Add new task"
                                            type="text">
                                        <button
                                            ...
                                            <div class="charts-data">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="progress progress-md flex-grow-1 mr-4">
                                                            <div aria-valuemax="100" aria-valuemin="0"
                                                                aria-valuenow="95" class="progress-bar bg-inf0"
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="progress progress-md flex-grow-1 mr-4">
                                                            <div aria-valuemax="100" aria-valuemin="0"
                                                                aria-valuenow="35" class="progress-bar bg-info"
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="progress progress-md flex-grow-1 mr-4">
                                                            <div aria-valuemax="100" aria-valuemin="0"
                                                                aria-valuenow="48" class="progress-bar bg-info"
                                                                role="progressbar" style="width: 48%"></div>
                                                        </div>
                                                        <p class="mb-0">992</p>
                                                    </div>
                                                </div>
                                                <div class="mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="progress progress-md flex-grow-1 mr-4">
                                                            <div aria-valuemax="100" aria-valuemin="0"
                                                                aria-valuenow="25" class="progress-bar bg-info"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="table-responsive">
                                                <table class="display expandable-table" id="example"
                                                    style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            <th>Quote#</th>
