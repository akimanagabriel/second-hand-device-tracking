            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <p class="card-description">Listing and operations to the system users</p>
                    </div>
                    <div>
                        <button class="btn btn-primary" data-target="#newUserModal" data-toggle="modal">New user</button>
                    </div>
                </div>
